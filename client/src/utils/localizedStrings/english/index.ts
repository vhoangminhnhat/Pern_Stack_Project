export const engLocalizedStrings = {
  ...
  StudentManagement: {
    ...
    Columns: {
      ...
      curricularUnits2ndSemEnrolled: "Curricular units 2nd sem (enrolled)",
      curricularUnits2ndSemApproved: "Curricular units 2nd sem (approved)",
      curricularUnits2ndSemGrade: "Curricular units 2nd sem (grade)",
      debtor: "Debtor",
    ...
    Sections: {
      ...
      riskAnalysisText:
        "{highRisk} out of {total} students ({highRiskPercentage}%) are identified as high-risk for dropout. Consider implementing intervention strategies such as academic counseling, mentoring programs, or additional support services.",
    },
    Placeholders: {
      ...
      enterUnitsEnrolled: "Enter units enrolled",
      enterUnitsApproved: "Enter units approved",
      enterGrade: "Enter grade",
      enterTotalEnrolled: "Enter total enrolled",
      enterTotalApproved: "Enter total approved",
      enterTotalFailed: "Enter total failed",
  ...
  TeacherManagement: {
    ...
    CreateTeacherFailed: "Failed to create teacher",
    ...
    Placeholders: {
      ...
      selectGender: "Select gender",
      enterProfileAvatar: "Enter profile avatar URL",
      enterCode: "Enter code",
      selectBirthDay: "Select birth day",
      enterPlaceOfOrigin: "Enter place of origin",
      enterIdentifyCard: "Enter identify card",
      selectDateOfIssue: "Select date of issue",
      enterPlaceOfIssue: "Enter place of issue",
  ...
  SubjectManagement: {
    ...
    CreateSubjectSuccess: "Subject created successfully",
    CreateSubjectFailed: "Failed to create subject",
    UpdateSubjectSuccess: "Subject updated successfully",
    UpdateSubjectFailed: "Failed to update subject",
